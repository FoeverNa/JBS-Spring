...
//	
	...
	public void insertBoard(BoardVO vo) {
		System.out.println("===> JDB 기반으로 insertBoard() 기능 처리");
		try {
	...
	public void updateBoard(BoardVO vo) {
		System.out.println("===> JDB 기반으로 updateBoard() 기능 처리");
		try {
			conn = JDBCUtil.getConnection();
	...
	public void deleteBoard(BoardVO vo) {
		System.out.println("===> JDB 기반으로 deleteBoard() 기능 처리");
		try {
			conn = JDBCUtil.getConnection();
	...
	public BoardVO getBoard(BoardVO vo) {
		System.out.println("===> JDB 기반으로 getBoard() 기능 처리");
		BoardVO board = null;
		try {
			conn = JDBCUtil.getConnection();
	...
	public List<BoardVO> getBoardList(BoardVO vo) {
		System.out.println("===> JDB 기반으로 getBoardList() 기능 처리");
		// 비어있는 리스트 컬렉션을 생성한다. 
